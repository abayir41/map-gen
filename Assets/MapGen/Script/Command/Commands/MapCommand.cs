...
namespace MapGen.Map.Brushes
{
    ...
    {
        private readonly MapBrush _obstaclesBrush;
        ...
        public MapCommand(MapBrush obstaclesBrush, List<Vector3Int> selectedCells, Grid grid, WorldCreator creator)
        {
        ...
        public void Execute()
        {
            _spawnData = _obstaclesBrush.GenerateMap(_selectedCells, _grid);
        }
