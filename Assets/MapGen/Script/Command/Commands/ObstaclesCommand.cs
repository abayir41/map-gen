...
{
    public class ObstaclesCommand : ICommand
    {
        private readonly ObstaclesBrush _obstaclesBrush;
        ...
        public ObstaclesCommand(ObstaclesBrush obstaclesBrush, List<Vector3Int> selectedCells, Grid grid, WorldCreator creator)
        {
